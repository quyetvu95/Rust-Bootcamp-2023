...
fn exercise7() {
    let mut v: Vec<String> = Vec::new();
    {
        ...
        let a = String::from_str(s).unwrap();
        v.push(a);
    }
    println!("{:?}", v);
}
...
// Make it compile
fn exercise8() {
    let mut accounting = vec![String::from("Alice"), String::from("Ben")];
    ...
    loop {
        ...
        let person = String::from_str(add_vec[0]).unwrap() ;
